...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Main service category, card and detail page';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiSubserviceSubservice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Child service used by service cards and work filters';
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reusable team member for Team Block';
...
export interface ApiWorkWork extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Work card, fixed hero and detail page constructor';
    displayName: 'Work';
    pluralName: 'works';
    singularName: 'work';
  };
  ...
  attributes: {
    ...
    celebrity: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    previewImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    previewVideo: Schema.Attribute.Media<'videos'>;
    projectLinkLabel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
