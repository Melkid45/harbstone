...
export default function RequestBlock({
    ...
    return (
        <BlockWrapper padding="y" background="dark">
            ...
            <div className={`${styles.request} ${styles['request--footer']}`}>
                <form
                    noValidate
                ...
                >
                    <div className={styles.request__fields}>
                        {inputs.map((input) => {
                            ...
                            const fieldId = `request-${input.name}`;
                            const isTextarea = input.type === 'textarea';
                            const fieldClassName = `
                                ${styles.request__field}
                                ${styles['request__field--dark']}
                                ${fieldError ? styles['request__field--invalid'] : ''}
                                text text--medium text--white-color
                            `;
                    ...
                    <div className={styles.request__bottom}>
                        <div className={styles.request__budget}>
                            <h3 className="text text--medium text--white-color">
                                Project budget
                            </h3>
                            <div
                                className={`
                    ...
                    <div className={styles.request__success} role="dialog" aria-modal="true" aria-live="polite">
                        <h3 className="heading heading--font-1 heading--standard heading--white-color">
                            Thanks! We heard you.
                        </h3>
